...
export class NPCShip extends Ship {
    ...
    createMesh() {
        ...
        try {
            ...
            geometry.center();
            const material = new THREE.MeshStandardMaterial({ color: this.color, emissive: this.color, emissiveIntensity: 0.15, transparent: true, opacity: 0.9, roughness: 0.5, metalness: 0.3 });
