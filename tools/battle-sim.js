...
const DEFAULT_LOADOUTS = {
    ...
    'mercenary-cruiser':     { high: ['medium-pulse-maser', 'medium-pulse-maser', 'medium-railgun', 'heavy-missile'], mid: ['shield-booster', 'afterburner', 'sensor-booster'], low: ['damage-mod', 'damage-control', 'armor-plate'] },
    'mercenary-battlecruiser': { high: ['medium-pulse-maser', 'medium-pulse-maser', 'medium-railgun', 'heavy-missile', 'heavy-missile'], mid: ['shield-booster', 'afterburner', 'sensor-booster'], low: ['damage-mod', 'gyrostabilizer', 'damage-control', 'point-defense-system'] },
    'mercenary-battleship':  { high: ['large-beam-maser', 'large-beam-maser', 'large-railgun', 'large-railgun', 'cruise-missile', 'cruise-missile'], mid: ['shield-booster', 'afterburner', 'sensor-booster', 'capacitor-booster'], low: ['damage-mod', 'gyrostabilizer', 'damage-control', 'point-defense-system-2', 'armor-plate'] },
    'pirate-frigate':        { high: ['small-pulse-maser', 'small-pulse-maser', 'light-missile'], mid: ['afterburner', 'warp-scrambler'], low: ['damage-mod'] },
    'pirate-destroyer':      { high: ['small-railgun', 'small-railgun', 'small-pulse-maser', 'light-missile'], mid: ['shield-booster', 'afterburner', 'stasis-webifier'], low: ['damage-mod', 'damage-control'] },
    'pirate-cruiser':        { high: ['medium-pulse-maser', 'medium-pulse-maser', 'medium-railgun', 'heavy-missile'], mid: ['shield-booster', 'afterburner', 'warp-disruptor'], low: ['damage-mod', 'damage-control', 'gyrostabilizer'] },
